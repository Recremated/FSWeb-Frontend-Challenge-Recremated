...
function Profile() {
  ...
  return (
    <section className="bg-[var(--profile-bg)] text-white py-16 px-6">
      <div className="w-2/3 mx-auto">
        <h2 className="text-4xl font-bold mb-12 text-[var(--heading-color)] ">
          {t("profile")}
        </h2>
        ...
        <div className="flex flex-col md:flex-row gap-10">
          <div className="w-full md:w-1/2 ">
            ...
            <table className="w-full text-left">
              <tbody>
                <tr>
                  <td className="py-2 pr-4 text-[var(--heading-color)] align-top">
                    {t("birthDate")}
                  </td>
