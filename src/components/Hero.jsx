...
function Hero() {
  ...
  return (
    <section className="flex flex-col lg:flex-row relative">
      ...
      <div className="absolute top-6 right-6 z-30 flex items-center gap-4 lg:hidden">
        <button
          onClick={() =>
            language === "en" ? changeLanguage("tr") : changeLanguage("en")
          }
          className="uppercase text-xs font-bold tracking-wide text-lime-400 hover:text-lime-300"
        >
          {t("changeLanguage")}
        </button>
      ...
      <div className="w-full lg:w-7/10 bg-[var(--profile-bg)] text-white p-10 md:p-16 lg:p-20 flex flex-col justify-center min-h-[50vh] lg:min-h-[60vh] relative">
        ...
        <div className="w-2/3 mx-auto">
          ...
          <p className="mb-10 text-white text-lg">{t("intro")}</p>
          ...
          <div className="flex gap-4">
            <a
              ...
              className="flex items-center gap-2 bg-white text-[var(--profile-bg)] px-5 py-2 rounded-[6px] font-medium hover:bg-gray-100 transition-colors"
            >
              <svg
                className="w-5 h-5"
                fill="currentColor"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 bg-transparent border border-white text-white px-5 py-2 rounded-[6px] font-medium hover:bg-white/10 transition-colors"
            >
              <svg
                className="w-5 h-5"
                fill="currentColor"
      ...
      <div className="w-full lg:w-3/10 bg-[var(--projects-bg)] flex items-center justify-center min-h-[50vh] lg:min-h-[60vh] relative">
        ...
        <div className="lg:hidden border-8 border-white rounded-2xl shadow-xl overflow-hidden">
          <img
      ...
      <div className="absolute top-1/2 left-[70%] transform -translate-x-1/2 -translate-y-1/2 z-10 hidden lg:block">
